...
declare -A perf_events=(
    ...
    ["backend_bound"]=f"{STALL_SLOT_BACKEND},{CPU_CYCLES},{BR_MIS_PRED}"
    ["frontend_bound"]=f"{STALL_SLOT_FRONTEND},{CPU_CYCLES},{BR_MIS_PRED}"
    ["bad_speculation"]=f"{OP_RETIRED},{CPU_CYCLES},{BR_MIS_PRED},{OP_SPEC},{STALL_SLOT}"
    ["retiring"]=f"{OP_RETIRED},{CPU_CYCLES},{OP_SPEC},{STALL_SLOT}"
